...
class Color
{
// source: http://www.farb-tabelle.de/de/farbtabelle.htm
...
public:
	...
	/*
	static const std::array<Color, 101> ColorPaletteBlue;
	static const std::array<Color, 29> ColorPaletteBrown;
	static const std::array<Color, 222> ColorPaletteGrey;
	static const std::array<Color, 84> ColorPaletteGreen;
	static const std::array<Color, 47> ColorPaletteOrange;
	static const std::array<Color, 62> ColorPaletteRed;
	static const std::array<Color, 54> ColorPaletteMagenta;
	static const std::array<Color, 37> ColorPaletteWhite;
	static const std::array<Color, 45> ColorPaletteYellow;
	*/

	static const std::vector<Color> ColorPaletteBlue;
	static const std::vector<Color> ColorPaletteBrown;
	static const std::vector<Color> ColorPaletteGrey;
	static const std::vector<Color> ColorPaletteGreen;
	static const std::vector<Color> ColorPaletteOrange;
	static const std::vector<Color> ColorPaletteRed;
	static const std::vector<Color> ColorPaletteMagenta;
	static const std::vector<Color> ColorPaletteWhite;
	static const std::vector<Color> ColorPaletteYellow;
